...
env = {
  ...
  repositoryOwner,
  description: `Stack for the ${deployEnvironment} CI pipeline deploying using the CDK. If you need the delete this stack, delete the ${deployEnvironment} CDK infrastructure stack first.`,
};
